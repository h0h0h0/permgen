...
/**
 * Encapsulates logic for prompt set entry page in the flattened scenario.
 * Includes QuickAddress pre-check and retrieval of the appropriate prompt set.
 ...
 *
 */
public class FlatPromptEntry implements Command {
    public static final String NAME = "FlatPromptEntry";

    public String execute(HttpServletRequest request,
            HttpServletResponse response) {
        String sDestinationPage = Constants.FLAT_PROMPT_ENTRY_PAGE;
        ...
        if ( sPromptSet.equals("") || sPromptSet.equals(PromptSet.OPTIMAL)) {
            ...
            request.setAttribute(Constants.BACK_COMMAND, FlatInit.NAME);
        ...
        } else    // must be a different prompt set so use that
        {
            ...
            request.setAttribute(Constants.BACK_COMMAND, FlatPromptEntry.NAME);
        ...
        try {
            ...
            searchService.setEngineType(searchService.SINGLELINE);
            searchService.setFlatten(true);
            String sLayout = (String) request.getSession().getAttribute(Constants.LAYOUT);
            CanSearch canSearch = searchService.canSearch(sDataId, sLayout,PromptSet.OPTIMAL);
            ...
            if ( canSearch.isOk() ) {
                ...
                sDestinationPage = Constants.FLAT_PROMPT_ENTRY_PAGE;
            } else {
            ...
            System.err.println("~~~~~~~ Caught exception in FlatPromptEntry command ~~~~~~~");
            e.printStackTrace();
            System.err.println("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~");
